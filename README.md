...
Download the HM3D dataset from the official repository: [matterport/habitat-matterport-3dresearch](https://github.com/matterport/habitat-matterport-3dresearch). 
...
Download the LHPR-VLN task dataset from HuggingFace: [Starry123/LHPR-VLN](https://huggingface.co/datasets/Starry123/LHPR-VLN).
